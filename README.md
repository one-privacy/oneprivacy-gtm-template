...
1. Sets `ads_data_redaction` and `url_passthrough` through `gtagSet`.
...
4. Paste your project ID and pick the environment. Use **Production** for a live site and **Test** for staging.
...
| Environment | Production | Loads the Live banner or the Test banner. |
